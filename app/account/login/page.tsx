  ...
  const handleSubmit = form.onSubmit(() => {
    ...
    setTimeout(() => {
      ...
      notifications.show({
        ...
        message: mode === "login" ? "You've been logged in successfully." : "Your account has been created.",
        color: "green",
    ...
    <Box style={{ minHeight: "100vh", display: "flex" }}>
      ...
      >
        ...
        <Box style={{ position: "relative", zIndex: 1 }}>
          <Text
            ...
            fw={600}
            tt="uppercase"
            style={{ letterSpacing: 2, color: "var(--afmondo-orange)" }}
            mb={12}
          >
            Afmondo Marketplace
          </Text>
        ...
        {/* Bottom — tagline */}
        <Box style={{ position: "relative", zIndex: 1 }}>
          <Text fz="xs" c="rgba(255,255,255,0.35)">
            © {new Date().getFullYear()} Afmondo · Dakar, Sénégal
          </Text>
        </Box>
      </Box>
      ...
      >
        ...
        <Box hiddenFrom="md" mb="xl">
          <Link href="/">
            <Image src="/logo.png" alt="Afmondo" width={120} height={42} style={{ objectFit: "contain" }} />
          </Link>
        </Box>
        ...
        <Box w="100%" style={{ maxWidth: 400 }}>
          ...
          <Text ta="center" fz="sm" c="dimmed">
            ...
            <Anchor
              ...
              c="orange.6"
              fw={600}
              onClick={() => { setMode(mode === "login" ? "register" : "login"); form.reset(); }}
            >
